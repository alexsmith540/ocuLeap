 ...
 */
THREE.OculusRiftEffect.prototype.render = function(scene, camera, vrstate,baseTexture,renderBool) {
  this.renderFlag = typeof renderBool == "undefined" ? true : renderBool;
  ...
  this.stereoRenderer_.render(vrstate || this.dummyState_, function(eye) {
    ...
    var v = typeof this.baseTexture != "undefined" ? false : true;
    this.renderer_.render(scene, this.eyeCamera_, this.baseTexture, this.renderFlag);
  }, this);
};
